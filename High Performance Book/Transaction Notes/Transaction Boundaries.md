...
- Where it **commits or rolls back**
...
- Breaks atomicity in multi-step operations
...
- First already committed → inconsistent state
...
> A transaction must wrap the **entire logical unit of work**
...
## Better Solution: Declarative Transactions
